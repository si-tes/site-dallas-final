...
interface YupooLeagueData {
  name: string;
  flag: string;
  category_id: string;
  products: YupooProduct[];
  count: number;
}

type ProductsJson = Record<string, YupooLeagueData>;

const yupooData = productsData as ProductsJson;
