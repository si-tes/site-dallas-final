...
export { listarProdutos, obterProduto, listarEstoqueComTamanhos, obterGaleriaProduto };
export default { listarProdutos, obterProduto, listarEstoqueComTamanhos, obterGaleriaProduto };